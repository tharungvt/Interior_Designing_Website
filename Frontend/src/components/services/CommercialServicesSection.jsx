...
export default function CommercialServicesSection({ content }) {
  ...
  return (
    <section
      id={id}
      className="py-16 sm:py-24 bg-[#F1F5F4] text-brand-charcoal scroll-mt-20"
      aria-labelledby="commercial-section-heading"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Featured Commercial Flagship (Office Interiors) */}
        {featured && (
          <div
            ...
            id="featured-commercial-discipline"
          >
