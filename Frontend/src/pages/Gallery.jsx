 ...
 *
 * Faithfully reproduces the supplied Figma design for the Interior Design Studio Gallery.
 * Supports URL search parameter-driven category filtering, responsive bento/masonry grid,
 * and high-resolution lightbox modal exploration.
 */
